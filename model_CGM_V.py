...
from attention import SemanticAlignment, SemanticAttention
...
class Decoder_no_ch(nn.Module):
    def __init__(self, word_embed_size, frame_embed_size, hidden_size, vocab_size,
        ...
        super(Decoder_no_ch, self).__init__()
        ...
        self.decoder = nn.LSTM((frame_embed_size+word_embed_size)+word_embed_size+hidden_size, hidden_size,
    ...
    def onestep_sgn(self, embedded, hidden, vis_feats, vid_out_rnn, phr_feats, phr_masks):
        last_hidden = hidden
    ...
    def forward(self,
        ...
        for t in range(1, max_len):
            ...
            output, output_logits, hidden, (sem_align_weights, _), (sem_align_logits, _) = self.onestep_sgn(
                embedded, hidden, pos_vis_feats, vid_out_rnn, phr_feats, phr_masks)  # (mb, vocab) (1, mb, N) (mb, 1, seqlen)
    ...
    def beam_decoding(self, init_decoder_hidden, vis_feats, vid_out_rnn, max_len, width=2):
        # 束搜索
        ...
        for t in range(1, max_len):
            ...
            for i, (input, hidden, cum_prob) in enumerate(zip(input_list, hidden_list, cum_prob_list)):
                ...
                output, output_logits, next_hidden, (sem_align_weights, _), (sem_align_logits, _) = self.onestep_sgn(
                    embedded, hidden, vis_feats, vid_out_rnn, phr_feats, phr_masks)  # (mb, vocab) (1, mb, N) (mb, 1, seqlen)
